...
SET P4_OPT=-p "p4p-tres02:1999" -u "saishige" -c "TresMain_saishige_PC4113_8761"

@::Cドライブのフォルダを更新
@::例) p4 %P4_OPT% sync "c:\Tres\UE4\TresMain\..."
p4 %P4_OPT% sync "c:\Tres\UE4\TresMain\..."

START C:\Tres\UE4\TresMain\Engine\Binaries\Win64\UE4Editor.exe
